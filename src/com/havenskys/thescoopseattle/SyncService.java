...
public class SyncService extends Service implements Runnable {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if( intent != null ){
            	...
            	if( intent.hasExtra("com.havenskys.newsbite.who") ){
    	            Bundle extras = intent.getExtras();
    	            who = extras.containsKey("com.havenskys.newsbite.who") ? extras.getString("com.havenskys.newsbite.who") : "";
    		...
    		//service.putExtra("com.havenskys.newsbite.who", TAG + " onCreate() Repeating Service Alarm minutes("+syncInterval+") at " + DateUtils.formatDateTime(mContext, System.currentTimeMillis(), DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_SHOW_YEAR | DateUtils.FORMAT_NUMERIC_DATE | DateUtils.FORMAT_SHOW_TIME ));
    		...
    		resetservice.setAction("com.havenskys.newsbite.SERVICE_SCHEDULE1");
			...
			//startservice.setClass(mContext, com.havenskys.newsbite.StartService.class);
			//startservice.putExtra("com.havenskys.newsbite.who", TAG + " handleMessage() StartService Activity Alarm");
			...
			//service2.setClass(mContext, com.havenskys.newsbite.StartService.class);
    		...
    		if( Runtime.getRuntime().freeMemory() < (MINMEMORY * 1024) ){
    			...
    			Intent resetservice = new Intent();
    	        //com.havenskys.newsbite.SERVICE_RESET
    		  	resetservice.setAction("com.havenskys.newsbite.IntentReceiver.SERVICE_RESET_1");
    			PendingIntent service3 = PendingIntent.getBroadcast(mContext, 0, resetservice, Intent.FLAG_ACTIVITY_NEW_TASK | PendingIntent.FLAG_CANCEL_CURRENT);
	...
	public void onCreate() {
		...
		Intent resetservice = new Intent();
        //com.havenskys.newsbite.SERVICE_RESET
		resetservice.setAction("com.havenskys.newsbite.SERVICE_SCHEDULE0");
		PendingIntent service3 = PendingIntent.getBroadcast(mContext, 0, resetservice, Intent.FLAG_ACTIVITY_NEW_TASK | PendingIntent.FLAG_CANCEL_CURRENT);
		//mAlM.set(AlarmManager.RTC_WAKEUP,( System.currentTimeMillis() + (syncInterval * 60 * 1000) ), service3);
		Date d = new Date(); 
		long lastrun = mSharedPreferences.getLong("lastrun", System.currentTimeMillis());
       ...
       Log.i(TAG,"onCreate() ServiceHandler");
		...
		//serviceH.setClass(mContext, com.havenskys.newsbite.SyncService.class);
		//serviceH.putExtra("com.havenskys.newsbite.who", TAG + " onCreate() Repeating Service Alarm minutes("+syncInterval+") at " + DateUtils.formatDateTime(mContext, System.currentTimeMillis(), DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_SHOW_YEAR | DateUtils.FORMAT_NUMERIC_DATE | DateUtils.FORMAT_SHOW_TIME ));
	...
	public void run() {
		...
		//Intent service = new Intent();
		//service.setClass(mContext, com.havenskys.newsbite.SyncService.class);
		//service.putExtra("com.havenskys.newsbite.who", TAG + " run() Repeating Service Alarm");
	...
	private void startUp() {
		...
		thr.setUncaughtExceptionHandler(new UncaughtExceptionHandler(){
			...
			public void uncaughtException(Thread thread, Throwable ex) {
				...
				//Intent service = new Intent();
				//service.setClass(mContext, com.havenskys.newsbite.SyncService.class);
				//service.putExtra("com.havenskys.newsbite.who", TAG + " startUp() Recovery Repeating Service Alarm");
				//PendingIntent serviceP = PendingIntent.getService(mContext, 1000, service, PendingIntent.FLAG_CANCEL_CURRENT);
				...
				Intent resetservice = new Intent();
		        //com.havenskys.newsbite.SERVICE_RESET
				resetservice.setAction("com.havenskys.newsbite.SERVICE_RECOVER0");
		...
		thr.setDefaultUncaughtExceptionHandler(new UncaughtExceptionHandler(){
			...
			public void uncaughtException(Thread thread, Throwable ex) {
				...
				Intent resetservice = new Intent();
		        //com.havenskys.newsbite.SERVICE_RESET
				resetservice.setAction("com.havenskys.newsbite.SERVICE_RECOVER1");
				//PendingIntent service3 = PendingIntent.getActivity(mContext, 0, resetservice, Intent.FLAG_ACTIVITY_NEW_TASK | PendingIntent.FLAG_CANCEL_CURRENT);
	...
	public void onLowMemory() {
		...
		Intent resetservice = new Intent();
        //com.havenskys.newsbite.SERVICE_RESET
		resetservice.setAction("com.havenskys.newsbite.SERVICE_RECOVER2");
		//PendingIntent service3 = PendingIntent.getActivity(mContext, 0, resetservice, Intent.FLAG_ACTIVITY_NEW_TASK | PendingIntent.FLAG_CANCEL_CURRENT);
